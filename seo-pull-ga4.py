...
def main():
    ...
    if not props:
        raise SystemExit("FAIL: zero in-scope properties with a GA4 id. There are several in the CC, so\n  this means the query or the DB connection is broken -- NOT that there is nothing to pull.")
