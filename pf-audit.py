...
row = q("SELECT count(*) total, count(*) FILTER (WHERE embedding IS NOT NULL AND embedded_hash = content_hash) emb FROM vault_notes WHERE tags && ARRAY['passionfit-concepts']")[0]
