...
MAP = [
    ...
    ("Clancy damage reviews", "Sygma", "CC Supabase public.clancy_damages + damage_review_rules", "cc-sql · the damage-review engine · /m/clancy-* pages", "Clancy strike/damage findings + the wording rules the review engine lints against."),
