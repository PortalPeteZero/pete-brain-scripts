...
MAP = [
    ...
    ("Claude-to-Claude exchange (Pete ⇄ Jim)", "Cross", "Google Chat space 'Claude Exchange' (spaces/AAQA66Jdho0) + Sygma Hub _System/claude-exchange/ (the file half)", "chat-api.py messages spaces/AAQA66Jdho0 15 · drive-api.py on the Hub folder · protocol = the space's pinned first message + Hub _System/README.md", "The standing channel between Pete's Claude and Jim's Claude (built 4 Aug 2026). Short coordination in the space, long payloads as files in the folder, and the RULE: a file drop with no space message = NOT delivered (request 07 sat unseen). Every message opens [Pete's Claude]/[Jim's Claude]; wired into brain Resume 6b + Compress 7d + closeout I9. No secrets, pointers only."),
